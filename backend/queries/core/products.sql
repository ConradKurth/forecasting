...
-- name: InsertProductsBatch :copyfrom
INSERT INTO products (id, integration_id, external_id, title, handle, product_type, status, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9);
